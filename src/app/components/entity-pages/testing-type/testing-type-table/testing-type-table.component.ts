...
import {TestingTypeEditorComponent} from '../testing-type-editor/testing-type-editor.component';
...
import {TestingTypeFilterComponent} from '../testing-type-filter/testing-type-filter.component';

@Component({
  selector: 'app-testing-type-table',
  templateUrl: './testing-type-table.component.html',
  styleUrls: ['./testing-type-table.component.less']
})
export class TestingTypeTableComponent implements OnInit {
  ...
  constructor(
    private http: TestingTypeRestService,
  ...
  create() {
    ...
    this.dialog.open(TestingTypeEditorComponent,
      {
        data: dialogData
  ...
  openFilter() {
    this.dialog.open(TestingTypeFilterComponent,
      {
